...
[![Build Status](https://travis-ci.com/abdallhsamy/nestjs_starterkit.svg?branch=master)](https://travis-ci.com/abdallhsamy/nestjs_starterkit)
[![Commitizen friendly](https://img.shields.io/badge/commitizen-friendly-brightgreen.svg)](http://commitizen.github.io/cz-cli/)
[![code style: prettier](https://img.shields.io/badge/code_style-prettier-ff69b4.svg)](https://github.com/prettier/prettier)
[![Conventional Commits](https://img.shields.io/badge/Conventional%20Commits-1.0.0-yellow.svg)](https://conventionalcommits.org)
[![GitHub issues](https://img.shields.io/github/issues/abdallhsamy/nestjs_starterkit)](https://github.com/abdallhsamy/nestjs_starterkit/issues)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/abdallhsamy/nestjs_starterkit)](https://github.com/abdallhsamy/nestjs_starterkit/pulls)
[![GitHub stars](https://img.shields.io/github/stars/abdallhsamy/nestjs_starterkit)](https://github.com/abdallhsamy/nestjs_starterkit/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/abdallhsamy/nestjs_starterkit)](https://github.com/abdallhsamy/nestjs_starterkit/network)
[![GitHub contributors](https://img.shields.io/github/contributors/abdallhsamy/nestjs_starterkit)](https://github.com/abdallhsamy/nestjs_starterkit/graphs/contributors)
[![GitHub license](https://img.shields.io/github/license/abdallhsamy/nestjs_starterkit)](https://github.com/abdallhsamy/nestjs_starterkit)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/abdallhsamy/nestjs_starterkit)
![GitHub repo size](https://img.shields.io/github/repo-size/abdallhsamy/nestjs_starterkit)
...
1. Clone the git repository
   ...
   ```bash
   git clone https://github.com/abdallhsamy/nestjs_starterkit.git
   ```

1. Go into the project directory

   ```bash
   cd nestjs_starterkit/
   ```
...
**CI workflow file**: [`.github/workflows/ci.yml`](../nestjs_starterkit/.github/workflows/ci.yml).
